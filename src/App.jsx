    ...
    <>
      <div ref={back} className='h-[calc(100vh)] w-100vw bg-gray-500 overflow-hidden relative py-10 '>
        ...
        <div className='sticky flex top:20 items-center bg-white px-10 translate-y-15'>
          ...
          <div className='h-40 w-[90%] mt-20 bg-[#45DB7D] rounded-full absolute text-center text-8xl font-stretch-50% font-bold items-center justify-center flex'><h1>WEL COME ITZFIZZ</h1></div>
